...
$auth_users = array(
    'admin' => '$2y$10$VsP.8hlm8R4Xvw6cBIkoOekCuYeISrLVEtcXV21xwk1y2qcDTRSpS', //admin@123
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> TITID FILE MANAGER <?php echo VERSION; ?></a></h3></p>
